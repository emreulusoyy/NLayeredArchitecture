...
{
    public partial class mig_hersey : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    İletişimID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SahısFirmaAdi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_iletisimFormus", x => x.İletişimID);
                });
